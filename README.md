...
## # Waggle Sales Performance Dashboard

## Project Overview
This project focuses on building an interactive Power BI dashboard to analyze sales performance, customer behavior, and business trends.
...
## Dashboard Insights
- Sales trends vary across regions
- Customer behavior supports strategic decisions
- Interactive dashboards improve reporting efficiency
